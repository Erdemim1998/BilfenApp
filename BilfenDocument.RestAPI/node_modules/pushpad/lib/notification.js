 ...
 *  This field is optional and the value defaults to the project name set in project settings.
 *
...
function Notification(options) {
  ...
  this.badgeUrl = options.badgeUrl;
...
Notification.prototype._reqBody = function (uids, tags) {
  ...
  if (this.badgeUrl) {
    body.notification.badge_url = this.badgeUrl;
  }
  if (this.imageUrl) {
  ...
  if (this.silent != null) {
    body.notification.silent = this.silent;
  }
  if (this.urgent != null) {
    body.notification.urgent = this.urgent;
  }
  if (this.customData) {
    body.notification.custom_data = this.customData;
  }
  if (this.customMetrics) {
    body.notification.custom_metrics = this.customMetrics;
  }
  ...
  if (this.sendAt) {
    body.notification.send_at = this.sendAt.toJSON();
  }
...
Notification.prototype._deliver = function (body, callback) {
  request
    .post('https://pushpad.xyz/api/v1/projects/' + this.project.projectId + '/notifications')
